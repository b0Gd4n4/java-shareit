...
public class RequestControllerTest {
    ...
    void createRequest() throws Exception {
        when(itemRequestService.createRequest(any(ItemRequestDto.class), anyLong())).thenReturn(firstItemRequestDto);
        ...
        verify(itemRequestService, times(1)).createRequest(firstItemRequestDto, 1L);
    }
